...
void defImguiMenu(Camera& cam) {
    ...
    ImGui::DragInt("Samples per Pixel", &cam.samples, 1, 1, 50, "%d", ImGuiSliderFlags_AlwaysClamp);
    ImGui::DragInt("Max Depth", &cam.depth, 1, 1, 300, "%d", ImGuiSliderFlags_AlwaysClamp);

    ImGui::SeparatorText("Camera");
    ImGui::DragFloat("Focus Distance", &cam.focal_len, 0.1f, 0.1f, 50.0f, "%.2f", ImGuiSliderFlags_AlwaysClamp);
